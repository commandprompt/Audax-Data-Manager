...
base_urlpatterns = [
    ...
    path('get_types_oracle/', views.tree_oracle.get_types,),
    path('get_table_definition_oracle/', views.tree_oracle.get_table_definition,),
    ...
    #TREE_SQLITE
    path('get_tree_info_sqlite/', views.tree_sqlite.get_tree_info, name='get_tree_info_sqlite'),
    path('get_tables_sqlite/', views.tree_sqlite.get_tables, name='get_tables_sqlite'),
    path('get_columns_sqlite/', views.tree_sqlite.get_columns, name='get_columns_sqlite'),
    path('get_pk_sqlite/', views.tree_sqlite.get_pk, name='get_pk_sqlite'),
    path('get_pk_columns_sqlite/', views.tree_sqlite.get_pk_columns, name='get_pk_columns_sqlite'),
    path('get_fks_sqlite/', views.tree_sqlite.get_fks, name='get_fks_sqlite'),
    path('get_fks_columns_sqlite/', views.tree_sqlite.get_fks_columns, name='get_fks_columns_sqlite'),
    path('get_uniques_sqlite/', views.tree_sqlite.get_uniques, name='get_uniques_sqlite'),
    path('get_uniques_columns_sqlite/', views.tree_sqlite.get_uniques_columns, name='get_uniques_columns_sqlite'),
    path('get_indexes_sqlite/', views.tree_sqlite.get_indexes, name='get_indexes_sqlite'),
    path('get_indexes_columns_sqlite/', views.tree_sqlite.get_indexes_columns, name='get_indexes_columns_sqlite'),
    path('get_triggers_sqlite/', views.tree_sqlite.get_triggers, name='get_triggers_sqlite'),
    path('get_views_sqlite/', views.tree_sqlite.get_views, name='get_views_sqlite'),
    path('get_views_columns_sqlite/', views.tree_sqlite.get_views_columns, name='get_views_columns_sqlite'),
    path('get_view_definition_sqlite/', views.tree_sqlite.get_view_definition, name='get_view_definition_sqlite'),
    path('get_properties_sqlite/', views.tree_sqlite.get_properties, name='get_properties_sqlite'),
    path('template_select_sqlite/', views.tree_sqlite.template_select, name='template_select_sqlite'),
    path('template_insert_sqlite/', views.tree_sqlite.template_insert, name='template_insert_sqlite'),
    path('template_update_sqlite/', views.tree_sqlite.template_update, name='template_update_sqlite'),
    path('get_table_definition_sqlite/', views.tree_sqlite.get_table_definition, name="get_table_definition_sqlite"),

    #TREE_MSSQL
    path('get_tree_info_mssql/', views.tree_mssql.get_tree_info, name='get_tree_info_mssql'),
    path('get_databases_mssql/', views.tree_mssql.get_databases, name='get_databases_mssql'),
    path('get_schemas_mssql/', views.tree_mssql.get_schemas, name='get_schemas_mssql'),
    path('get_tables_mssql/', views.tree_mssql.get_tables, name='get_tables_mssql'),
    path('get_columns_mssql/', views.tree_mssql.get_columns, name='get_columns_mssql'),
    path('get_pk_mssql/', views.tree_mssql.get_pk, name='get_pk_mssql'),
    path('get_pk_columns_mssql/', views.tree_mssql.get_pk_columns, name='get_pk_columns_mssql'),
    path('get_fks_mssql/', views.tree_mssql.get_fks, name='get_fks_mssql'),
    path('get_fks_columns_mssql/', views.tree_mssql.get_fks_columns, name='get_fks_columns_mssql'),
    path('get_uniques_mssql/', views.tree_mssql.get_uniques, name='get_uniques_mssql'),
    path('get_uniques_columns_mssql/', views.tree_mssql.get_uniques_columns, name='get_uniques_columns_mssql'),
    path('get_checks_mssql/', views.tree_mssql.get_checks, name='get_checks_mssql'),
    path('get_views_mssql/', views.tree_mssql.get_views, name='get_views_mssql'),
    path('get_views_columns_mssql/', views.tree_mssql.get_views_columns, name='get_views_columns_mssql'),
    path('get_procedures_mssql/', views.tree_mssql.get_procedures, name='get_procedures_mssql'),
    path('get_procedure_fields_mssql/', views.tree_mssql.get_procedure_fields, name='get_procedure_fields_mssql'),
    path('get_statistics_mssql/', views.tree_mssql.get_statistics, name='get_statistics_mssql'),
    path('get_functions_mssql/', views.tree_mssql.get_functions, name='get_functions_mssql'),
    path('get_function_fields_mssql/', views.tree_mssql.get_function_fields, name='get_function_fields_mssql'),
    path('get_indexes_mssql/', views.tree_mssql.get_indexes, name='get_indexes_mssql'),
    path('get_indexes_columns_mssql/', views.tree_mssql.get_indexes_columns, name='get_indexes_columns_mssql'),
    path('get_triggers_mssql/', views.tree_mssql.get_triggers, name='get_triggers_mssql'),
    path('get_server_roles_mssql/', views.tree_mssql.get_server_roles, name='get_server_roles_mssql'),
    path('get_database_roles_mssql/', views.tree_mssql.get_database_roles, name='get_database_roles_mssql'),
    path('get_logins_mssql/', views.tree_mssql.get_logins, name='get_logins_mssql'),
    path('get_users_mssql/', views.tree_mssql.get_users, name='get_users_mssql'),
    path('template_select_mssql/', views.tree_mssql.template_select, name='template_select_mssql'),
    path('get_properties_mssql/', views.tree_mssql.get_properties, name='get_properties_mssql'),
    path('get_table_definition_mssql/', views.tree_mssql.get_table_definition, name='get_table_definition_mssql'),
    path('get_types_mssql/', views.tree_mssql.get_types, name='get_types_mssql'),
